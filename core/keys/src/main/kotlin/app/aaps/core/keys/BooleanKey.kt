...
enum class BooleanKey(
    ...
    // Konzept 9 (2026-08-26) — SHADOW ONLY. Reads Health Connect SleepSessionRecord/RestingHeartRateRecord
    // (the watch's own sleep-tracking verdict) purely as a second opinion logged next to Boost's existing
    // HR-derived SleepStateDetector — never overrides it, never touches TT/dosing.
    ApsBoostHealthConnectSleepEnabled("boost_health_connect_sleep_enabled", false, defaultedBySM = true),
