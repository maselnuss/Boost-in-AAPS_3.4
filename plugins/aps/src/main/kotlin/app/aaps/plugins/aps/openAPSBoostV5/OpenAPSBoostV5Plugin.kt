...
open class OpenAPSBoostV5Plugin @Inject constructor(
    ...
    private fun scheduleConfigEvaluation() {
        ...
        configExecutor.execute {
            try {
                ...
                // the automatic path silently overwrite a suggestion the user just reviewed or
                // rejected. Code kept intact so it can be switched on later without a re-port.
    ...
    private val prefScreenKeys = setOf(
        ...
        "boost_default_aaps_settings", "boost_dynisf_settings", "boost_shadow_concepts_settings",
        "boost_exercise_settings",
